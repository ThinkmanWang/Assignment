...
//	private int size = 0; // number of nodes in the tree
	...
	/**
	 * Creates a new left child of Node p storing element e and returns its
	 * Node.
	 *
	 * @param p the Node to the left of which the new element is inserted
	 * @param e the new element
	 * @return the Node of the new element
	 * @throws IllegalArgumentException if p is not a valid Node for this tree
	...
	/**
	 * Creates a new right child of Node p storing element e and returns its
	 * Node.
	 *
	 * @param p the Node to the right of which the new element is inserted
	 * @param e the new element
	 * @return the Node of the new element
	 * @throws IllegalArgumentException if p is not a valid Node for this tree.
	...
	/**
	 * Replaces the element at Node p with element e and returns the replaced
	 * element.
	 *
	 * @param p the relevant Node
	 * @param e the new element
	...
	/**
	 * Removes the node at Node p and replaces it with its child, if any.
	 *
	 * @param p the relevant Node
